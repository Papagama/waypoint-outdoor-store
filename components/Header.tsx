...
function CartDrawer() {
  ...
  return <div className="drawer-wrap" role="dialog" aria-modal="true" aria-label="Корзина">
    ...
    <aside className="cart-drawer">
      <div className="drawer-head"><div><h2>Корзина</h2></div><button className="icon-button" onClick={closeCart} aria-label="Закрыть корзину"><X /></button></div>
